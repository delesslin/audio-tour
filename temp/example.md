...
The "###" indicates the image file. Currently these can be either remote resources (i.e. starting with "http") or local resources.
...
To clarify, each paragraph of this .md file that does not start with #, ##, or ### will be rendered as a paragraph of the Stop Text (also called text or transcript as it corresponds to the recorded text in the audio file)
